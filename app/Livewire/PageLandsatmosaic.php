...
class PageLandsatmosaic extends Component
{
    public $contentEN, $contentID;

    public function mount(){
        $data = DB::table('pagelandsatmosaic')->where('id', 1)->first();
        if($data){
    ...
    {
        return view('livewire.page-landsatmosaic');
    }
}
