...
class PageCollectionmap extends Component
{
    public $contentEN, $contentID;

    public function mount(){
        $data = DB::table('pagecollectionmap')->where('id', 1)->first();
        if($data){
    ...
    {
        return view('livewire.page-collectionmap');
    }
}
