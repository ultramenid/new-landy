...
@section('content')
    ...
    <div class="sm:px-0 px-4">
        <div class="max-w-3xl mx-auto bg-white relative  -mt-20 z-20 rounded sm:px-6 px-4 sm:py-12 py-4 border-b border-landy min-h-[40vh]">
            <a class="text-3xl font-semibold capitalize">{{__('landsat mosaics') }}</a>
            <div class="prose max-w-none mt-4 sm:text-base text-sm leading-relaxed font-light text-wrap" style="word-break: break-all; white-space: normal;">
