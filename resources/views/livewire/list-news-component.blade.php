                ...
                <table class="w-full divide-y divide-gray-200 dark:divide-gray-800 rounded-lg  ">
                    <thead >
                        <tr >
                            ...
                            <th  class=" cursor-pointer px-4 py-3 bg-gray-50 dark:bg-opacity-10  dark:text-white text-center font-medium text-gray-500 uppercase tracking-wider  sm:w-2/12 w-0">
                                <div class=" space-x-1 hidden sm:flex justify-center">
                                    <a class="hidden sm:block text-xs">Category</a>
                        ...
                        <tr>
                            ...
                            <td class=" py-4 break-words text-sm text-center  text-newgray-700 dark:text-gray-300">
                                 @if( $item->category == 'news')
                                    <a class="break-all sm:inline-flex hidden justify-between  bg-landy dark:bg-newgray-700  rounded mt-1 py-2 px-2 focus:outline-none items-center">{{$item->category}}</a>
                                @else
                                    <a class="break-all sm:inline-flex hidden justify-between  bg-landy-2 dark:bg-newgray-700  rounded mt-1 py-2 px-2 focus:outline-none items-center">{{$item->category}}</a>
                                @endif
                            </td>
