<div class="border-b border-gray-300 bg-gray-100 dark:bg-newgray-900 bg-opacity-90 dark:border-opacity-20  z-10 ">
    <div class="max-w-6xl mx-auto px-6 "  x-data="{ pages: false }">
        <nav class="-mb-px flex space-x-4 text-sm leading-5 overflow-x-auto scrollbar-hide text-gray-500 select-none">
            ...
            <div class="hover:bg-gray-200 dark:hover:bg-newgray-700 py-3 px-2 rounded @if($nav == 'mural' )border-b-2  dark:border-gray-300 border-newgray-900 @endif ">
                <a href="{{url('/cms/cmsmural')}}" class=" px-0.5  @if($nav == 'mural' )   text-newgray-900 dark:text-gray-300 @endif   hover:text-newgray-900 dark:hover:text-gray-300 cursor-pointer" >mural</a>
            </div>
            ...
            <div @click="pages = ! pages" @click.away="pages=false" class=" cursor-pointer flex-col flex hover:bg-gray-200 dark:hover:bg-newgray-700 py-3  rounded @if($nav == 'pages' )border-b-2  dark:border-gray-300 border-newgray-900 @endif " x-data="{pages:false}">
                ...
                <div class=" flex flex-col space-y-3  w-52  rounded absolute sm:mt-10 mt-10 z-20 bg-gray-200 dark:bg-newgray-700  px-4 py-2" x-show="pages" x-cloak style="display: none !important">
                    ...
                    <a  href="{{url('/cms/pagestatistics')}}" class="hover:text-newgray-900 dark:hover:text-gray-300">statistics</a>
                    <a  href="{{url('/cms/pageaccuracy')}}" class="hover:text-newgray-900 dark:hover:text-gray-300">accuracy assessment</a>
                    <a  href="{{url('/cms/pagegee')}}" class="hover:text-newgray-900 dark:hover:text-gray-300">google earth engine</a>
                    <a  href="{{url('/cms/pageglossary')}}" class="hover:text-newgray-900 dark:hover:text-gray-300">glossary</a>
